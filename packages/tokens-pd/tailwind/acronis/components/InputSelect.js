...
// Source: @acronis-platform/design-tokens • brand: acronis • component: InputSelect
  ...
  theme: {
    extend: {
      ...
      "textColor": {
        ...
        "input-select-error-icon-expand-disabled": "light-dark(rgb(214 228 245), rgb(6 54 121))",
