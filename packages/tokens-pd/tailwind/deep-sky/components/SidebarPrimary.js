...
// Source: @acronis-platform/design-tokens • brand: deep-sky • component: SidebarPrimary
  ...
  theme: {
    extend: {
      "textColor": {
        ...
        "sidebar-primary-menu-item-selected-icon-idle": "light-dark(rgb(255 255 255 / 0.6), rgb(0 0 0 / 0.6))",
